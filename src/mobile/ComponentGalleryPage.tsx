...
export const ComponentGalleryPage: React.FC<ComponentGalleryPageProps> = ({ componentKey }) => {
  ...
  const activeDemo = useMemo(() => demos[activeIndex] || demos[0], [demos, activeIndex]);
    ...
    <div className='mk-mobile-component-page'>
      <div className='mk-mobile-component-card'>
        <header className='mk-mobile-component-header'>
          <a href='/gallery' className='mk-mobile-component-back' aria-label='返回'>
            ‹
          </a>
          <div className='mk-mobile-component-title'>{component.title}</div>
          <button
            type='button'
